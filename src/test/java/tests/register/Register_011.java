...
public class Register_011 extends BaseTest {
    HomePage homePage;
    LoginPage loginPage;
    RegisterPage registerPage;

    @Description("Boş MobilePhone Alanı ile Kayıt İşlemi")
    @Test
    public void register_011() {
        ...
        Assert.assertEquals("Lütfen bu alanı doldurun.", loginPage.getEmailValidationMessage(mobilePhone));
