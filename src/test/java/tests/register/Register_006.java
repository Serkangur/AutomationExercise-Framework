...
public class Register_006 extends BaseTest {
    HomePage homePage;
    LoginPage loginPage;
    RegisterPage registerPage;

    @Description("Boş LastName Alanı ile Kayıt İşlemi")
    @Test
    public void register_006() {
        ...
        Assert.assertEquals("Lütfen bu alanı doldurun.", loginPage.getEmailValidationMessage(lastName));
