...
public class Register_007 extends BaseTest {
    HomePage homePage;
    LoginPage loginPage;
    RegisterPage registerPage;

    @Description("Boş Adresss Alanı ile Kayıt İşlemi")
    @Test
    public void register_007() {
        ...
        Assert.assertEquals("Lütfen bu alanı doldurun.", loginPage.getEmailValidationMessage(adress));
