...
public class Register_009 extends BaseTest{
    HomePage homePage;
    LoginPage loginPage;
    RegisterPage registerPage;

    @Description("Boş City Alanı ile Kayıt İşlemi")
    @Test
    public void register_009() {
        ...
        Assert.assertEquals("Lütfen bu alanı doldurun.", loginPage.getEmailValidationMessage(city));
